...
router.get("/:studentId/courses",(req: Request, res: Response) => {
        ...
        const found = students.findIndex((std: Student) => std.studentId === studentId);
        ...
        const courseId = courses.filter(objA => foundcourseId?.some(objB => objB === objA.courseId));
